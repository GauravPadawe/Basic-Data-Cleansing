...
x = file.parse(u'7.1', skiprows=5, skip_footer=14, names=['Year','Total','Males','Females','Nan', 'None'])
#print (x)
drop_7_1 = x.dropna(axis=1).set_index('Year')
print (drop_7_1)
print (drop_7_1.describe())
...
#print (y)
index_rename = y.rename(columns={'Unnamed: 0': 'Year'})
#print (index_rename)
cleaned_7_2 = index_rename.drop(index_rename.index[0])
drop_na = cleaned_7_2.dropna(axis=1).set_index('Year')
print (drop_na)
